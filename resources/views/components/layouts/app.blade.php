    ...
    <div class="container mx-auto p-4 flex justify-between items-center">
        ...
        <nav>
            <ul class="flex space-x-6 text-[#4154F1] text-[16px] hover:transition-all">
                <li><a wire:navigate href="{{ route("welcome") }}" class="hover:underline  font-semibold mx-4">الرئيسية</a></li>
                ...
                <li><a wire:navigate href="{{ route("login") }}" class="hover:underline font-semibold">تسجيل الدخول</a></li>
            </ul>
        </nav>
    </div>
</header>
